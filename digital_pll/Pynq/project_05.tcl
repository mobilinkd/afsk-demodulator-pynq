...
Mobilinkd:afsk:demodulate5:1.0\
...
proc create_hier_cell_demodulator { parentCell nameHier } {
  ...
  set demod [ create_bd_cell -type ip -vlnv Mobilinkd:afsk:demodulate5:1.0 demod ]
  ...
  connect_bd_intf_net -intf_net demodulate5_0_output_r [get_bd_intf_pins demod/output_r] [get_bd_intf_pins dma/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins dma/S_AXI_LITE]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins m_axi_mm2s_aclk] [get_bd_pins demod/ap_clk] [get_bd_pins dma/m_axi_mm2s_aclk] [get_bd_pins dma/m_axi_s2mm_aclk] [get_bd_pins dma/s_axi_lite_aclk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins demodulator/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
