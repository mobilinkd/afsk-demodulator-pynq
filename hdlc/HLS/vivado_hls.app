<project xmlns="com.autoesl.autopilot.project" top="hdlc_top" name="HLS">
    ...
    <files xmlns="">
        <file name="../hdlc_test.cpp" sc="0" tb="1" cflags=" -std=c++11 -Wall -Wextra -Wno-unknown-pragmas" blackbox="false"/>
        <file name="../dpll_data.hpp" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" blackbox="false"/>
        <file name="HLS/nrzi.hpp" sc="0" tb="false" cflags="" blackbox="false"/>
        <file name="HLS/hdlc_top.hpp" sc="0" tb="false" cflags="" blackbox="false"/>
        <file name="HLS/hdlc_top.cpp" sc="0" tb="false" cflags="-std=c++11 -Wall -Wextra -Wno-unknown-pragmas" blackbox="false"/>
